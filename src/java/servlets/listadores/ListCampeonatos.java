 ...
 * @author Filipe
 */
@WebServlet(name = "ListCampeonatos", urlPatterns = {"/ListCampeonatos"})
public class ListCampeonatos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Listar Campeonatos</title>");     
            ...
            DAOCampeonato dp = new DAOCampeonato();
            List<Campeonato> cats;
            try {
                cats = dp.listarCampeonato();
                for(Campeonato model : cats) {
                    out.println("<div>"+
                            model.getNome()+" | "+
                            model.getDatInicio()+" | "+
                            model.getDatFim()+" | "+
                            model.getRegulamento()+
                            "</div>");
                }
